                                ...
                                <div class="table-responsive">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            $result = rec_info_outbox($connect);
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <td  style="padding-right: 5px;">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" id="rec_num" name="rec_number" value="<?php echo $row["tag"]; ?>" <?php if(in_array($row["tag"], $session_rec_no)) echo "checked='checked'"; ?>> <?php echo $row["tag"]; ?>
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <?php
...
<script>
    ...
    $('#sms_table tbody').on( 'change', '.stat', function (e) {
        ...
        if(id){
            $.ajax({
                url:"approve_outbox.php?id=" + id + "&active="+ status +"",
                method:"POST",
